...
define('_JSHOP_ATTR_NAME_BOLD', 'Назва');
define('_JSHOP_ATTR_USAGE_BOLD', 'Застосування');
...
define('_JSHOP_SEARCH_PLACEHOLDER','Введіть код запчастини');
