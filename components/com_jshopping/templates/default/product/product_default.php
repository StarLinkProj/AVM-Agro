...
<div class="jshop productfull" id="comjshop">
    <form name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="row-fluid-prod jshop">
        ...
        <div class="jshop_prod_description">
            ...
            <?php if ($this->config->product_list_show_product_code){?>
                <div class="jshop_code_prod">
                    <span class="attr-code"><?php print _JSHOP_EAN?>:</span> <span><?php print $product->product_ean;?></span></div>
            <?php }?>

            <div class="description">
                <span class="attr-size"><?php print _JSHOP_ATTR_SIZE_BOLD?>:</span>
                <?php print $product->description?>
            </div>

            <div class="good-usage">
                <span class="attr-usage"><?php print _JSHOP_ATTR_USAGE_BOLD?>:</span>
                <span class="data"><?php print $product->short_description;?></span>
            </div>
